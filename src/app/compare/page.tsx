...
export const metadata: Metadata = {
  title: "Version Comparison | Supermarket Simulator Guide",
  description: "Compare Supermarket Simulator versions and similar games.",
  openGraph: {
    title: "Version Comparison | Supermarket Simulator Guide",
    description: "Compare Supermarket Simulator versions and similar games.",
  },
  ...
  return (
    <div className="flex flex-col min-h-screen bg-zinc-950 text-zinc-100">
      ...
      <main className="flex-1 max-w-4xl mx-auto px-6 py-12 w-full">
        <h1 className="text-3xl md:text-4xl font-bold mb-4">Version Comparison</h1>
        <p className="text-zinc-400 mb-8 text-lg">Compare Supermarket Simulator versions and similar games.</p>
        
        <div className="p-8 rounded-xl bg-zinc-900 border border-zinc-800 text-center">
          <p className="text-zinc-500 mb-4">This guide is being written. Check back soon for the complete version comparison.</p>
