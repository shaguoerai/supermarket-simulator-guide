...
export const metadata: Metadata = {
  ...
  description: "Complete product ranking for Supermarket Simulator.",
  openGraph: {
    title: "Product Tier List | Supermarket Simulator Guide",
    description: "Complete product ranking for Supermarket Simulator.",
  },
  ...
  return (
    <div className="flex flex-col min-h-screen bg-zinc-950 text-zinc-100">
      ...
      <main className="flex-1 max-w-4xl mx-auto px-6 py-12 w-full">
        ...
        <p className="text-zinc-400 mb-8 text-lg">Complete product ranking for Supermarket Simulator.</p>
