    ...
    <div className="flex flex-col min-h-screen bg-zinc-950 text-zinc-100">
      ...
      <main className="flex-1 max-w-4xl mx-auto px-6 py-12 w-full">
        ...
        <div className="space-y-10">
          <section>
            <h2 className="text-xl font-bold mb-3 text-emerald-400">1. Information We Collect</h2>
          ...
          <section>
            <h2 className="text-xl font-bold mb-3 text-emerald-400">2. How We Use Your Information</h2>
            <p className="text-zinc-300 leading-relaxed mb-3">
          ...
          <section>
            <h2 className="text-xl font-bold mb-3 text-emerald-400">3. Third-Party Services</h2>
            <p className="text-zinc-300 leading-relaxed mb-3">
            ...
            <div className="space-y-3">
              <div className="p-4 rounded-lg bg-zinc-900 border border-zinc-800">
                ...
                <p className="text-zinc-400 text-sm">Tracks website traffic and user behavior. Data is anonymized where possible.</p>
              </div>
              <div className="p-4 rounded-lg bg-zinc-900 border border-zinc-800">
                <div className="flex items-center gap-2 mb-1">
                  <ExternalLink className="w-4 h-4 text-emerald-400" />
                ...
                <p className="text-zinc-400 text-sm">Displays personalized advertisements. Uses cookies to serve ads based on your interests.</p>
              </div>
            </div>
          </section>

          <section>
            <h2 className="text-xl font-bold mb-3 text-emerald-400">4. Cookies</h2>
            <p className="text-zinc-300 leading-relaxed mb-3">
            ...
            <div className="p-4 rounded-lg bg-zinc-900 border border-zinc-800">
              <div className="flex items-start gap-3">
                <Cookie className="w-5 h-5 text-emerald-400 mt-0.5" />
                <div>
                  <p className="text-zinc-300 text-sm font-semibold mb-1">Cookie Preferences</p>
                  <p className="text-zinc-400 text-sm">You can change your cookie preferences at any time by clearing your browser cookies and revisiting the site. Essential cookies (required for site functionality) cannot be disabled.</p>
                </div>
              </div>
            </div>
          </section>
          ...
          <section>
            <h2 className="text-xl font-bold mb-3 text-emerald-400">5. Your Rights (GDPR & CCPA)</h2>
            <p className="text-zinc-300 leading-relaxed mb-3">
          ...
          <section>
            <h2 className="text-xl font-bold mb-3 text-emerald-400">6. California Privacy Rights (CCPA)</h2>
            <p className="text-zinc-300 leading-relaxed mb-3">
            ...
            <div className="p-4 rounded-lg bg-zinc-900 border border-zinc-800">
              <p className="text-zinc-300 text-sm font-semibold mb-2">Do Not Sell My Personal Information</p>
              ...
              <ul className="mt-2 space-y-1 text-zinc-400 text-sm list-disc list-inside">
                ...
                <li>Visit <a href="https://adssettings.google.com" target="_blank" rel="noopener noreferrer" className="text-emerald-400 hover:underline">Google Ad Settings</a> to manage your ad preferences</li>
                <li>Visit <a href="https://optout.aboutads.info" target="_blank" rel="noopener noreferrer" className="text-emerald-400 hover:underline">Your Online Choices</a> to opt out of interest-based advertising</li>
              </ul>
            </div>
          </section>

          <section>
            <h2 className="text-xl font-bold mb-3 text-emerald-400">7. Data Retention</h2>
          ...
          <section>
            <h2 className="text-xl font-bold mb-3 text-emerald-400">8. Contact Us</h2>
            <p className="text-zinc-300 leading-relaxed mb-3">
              If you have any questions about this Privacy Policy or wish to exercise your rights, please contact us:
            </p>
            <div className="p-4 rounded-lg bg-zinc-900 border border-zinc-800 inline-flex items-center gap-3">
              <Mail className="w-5 h-5 text-emerald-400" />
              <a href="mailto:privacy@supermarketsimulator.guide" className="text-emerald-400 hover:underline">
