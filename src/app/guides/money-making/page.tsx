...
export const metadata: Metadata = {
  ...
  description: "Best strategies to earn money fast in Supermarket Simulator.",
  openGraph: {
    title: "Money Making Guide | Supermarket Simulator Guide",
    description: "Best strategies to earn money fast in Supermarket Simulator.",
  },
  ...
  return (
    <div className="flex flex-col min-h-screen bg-zinc-950 text-zinc-100">
      ...
      <main className="flex-1 max-w-4xl mx-auto px-6 py-12 w-full">
        ...
        <p className="text-zinc-400 mb-8 text-lg">Best strategies to earn money fast in Supermarket Simulator.</p>
        
        <div className="p-8 rounded-xl bg-zinc-900 border border-zinc-800 text-center">
          <p className="text-zinc-500 mb-4">This guide is being written. Check back soon for the complete money making guide.</p>
