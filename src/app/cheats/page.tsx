...
export const metadata: Metadata = {
  ...
  description: "All cheats and console commands for Supermarket Simulator.",
  openGraph: {
    title: "Cheats & Console Commands | Supermarket Simulator Guide",
    description: "All cheats and console commands for Supermarket Simulator.",
  },
  ...
  return (
    <div className="flex flex-col min-h-screen bg-zinc-950 text-zinc-100">
      ...
      <main className="flex-1 max-w-4xl mx-auto px-6 py-12 w-full">
        ...
        <p className="text-zinc-400 mb-8 text-lg">All cheats and console commands for Supermarket Simulator.</p>
        
        <div className="p-8 rounded-xl bg-zinc-900 border border-zinc-800 text-center">
          <p className="text-zinc-500 mb-4">This guide is being written. Check back soon for the complete cheats & console commands.</p>
